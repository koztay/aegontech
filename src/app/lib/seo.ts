export const siteConfig = {
  ...
  author: "AegonTech Team",
  creator: "AegonTech",
};

export const pageMetadata = {
  home: {
    title: "AegonTech - Leading Software Development Agency",
  ...
  privacy: {
    title: "Privacy Policy - AegonTech",
